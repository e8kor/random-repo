...
object Deserializable {
  ...
  type DeserializeFromMap[T] = Deserializable[Map[String, String], T]
  ...
  implicit class MapDeserializableOps(raw: Map[String, String]) {
    ...
    def deserialize[A: DeserializeFromMap]: A = {
      val ev = implicitly[DeserializeFromMap[A]]
      ev.deserialize(raw)
    }

    def deserializeOpt[A: DeserializeFromMap]: Option[A] = {
      val ev = implicitly[DeserializeFromMap[A]]
  ...
  implicit object HeadingLocationDeserializer extends DeserializeFromMap[HeadingLocation] {
  ...
  implicit object LeavingLocationDeserializer extends DeserializeFromMap[LeavingLocation] {
  ...
  implicit object LocationDeserializer extends DeserializeFromMap[Location] {
  ...
  implicit object AirportDeserializer extends DeserializeFromMap[Airport] {
  ...
  implicit object RunawayDeserializer extends DeserializeFromMap[Runaway] {
  ...
  implicit object CountryDeserializer extends DeserializeFromMap[Country] {
